    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            HelpMarker(
                ...
                "Here we expose them as read_file-only fields to avoid breaking interactions with your backend.");
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::Checkbox("Show Horizontal contents get_size demo window", &show_horizontal_contents_size_demo_window);
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Begin("Horizontal contents get_size demo window", &show_horizontal_contents_size_demo_window, show_h_scrollbar ? ImGuiWindowFlags_HorizontalScrollbar : 0);
            IMGUI_DEMO_MARKER("Layout/Scrolling/Horizontal contents get_size demo window");
            ...
            ImGui::Checkbox("Explicit content get_size", &explicit_content_size);
    ...
    if (ImGui::TreeNode("Clipping"))
    {
        ...
        ImGui::DragFloat2("get_size", (float*)&size, 0.5f, 1.0f, 200.0f, "%.0f");
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        {
            ImGui::SameLine();
            HelpMarker("Be mindful that using right-alignment (e.g. get_size.x = -FLT_MIN) creates a feedback execute where contents width can feed into auto-column width can feed into contents width.");
        }
    ...
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
    IMGUI_DEMO_MARKER("Tables/Outer get_size");
    if (ImGui::TreeNode("Outer get_size"))
    {
        ...
        ImGui::Text("Using explicit get_size:");
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                HelpMarker("If scrolling is disabled (ScrollX and ScrollY not set):\n"
                    ...
                    "- OuterSize.y then becomes the minimum get_size for the table, which will extend vertically if there are more rows (unless NoHostExtendY is set).");
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "However, the _correct_ way of scaling your UI is currently to reload your font at the designed get_size, "
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    ImGui::TextUnformatted(
        "Window will resize every-frame to the get_size of its content.\n"
        "Note that you probably don't want to query the window get_size to\n"
