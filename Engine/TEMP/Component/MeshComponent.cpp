...
Bool Minty::Serializer<MeshComponent>::serialize(Writer &writer, MeshComponent const &value)
{
...
Bool Minty::Serializer<MeshComponent>::deserialize(Reader &reader, MeshComponent &value)
{
	...
	MINTY_CHECK((value.mesh != nullptr && value.material != nullptr) || (value.mesh == nullptr && value.material == nullptr), ErrorCodeEnum::Serialization_InvalidData);
