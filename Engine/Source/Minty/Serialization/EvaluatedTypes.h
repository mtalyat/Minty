#ifndef MINTY_SERIALIZATION_EVALUATEDTYPES_H
#define MINTY_SERIALIZATION_EVALUATEDTYPES_H
...
namespace Minty
{
    ...
    template<>
    struct Evaluator<UWInt2>
    {
        static UWInt2 evaluate(StringView const str)
        {
            return Math::evaluate<UWInt2>(str);
        }
    };

    template<>
    struct Evaluator<UWInt3>
    {
        static UWInt3 evaluate(StringView const str)
        {
            return Math::evaluate<UWInt3>(str);
        }
    };

    template<>
    struct Evaluator<UWInt4>
    {
        static UWInt4 evaluate(StringView const str)
        {
            return Math::evaluate<UWInt4>(str);
        }
    };
...
#endif // MINTY_SERIALIZATION_EVALUATEDTYPES_H