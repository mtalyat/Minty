...
Char const *Minty::get_error_message(ErrorCode const code)
{
    ...
    case ErrorCode::Argument_OutOfBounds:
    ...
    case ErrorCode::Component_NotRegistered:
        return "Component error. Component not registered in the Context. ";
    case ErrorCode::Component_AlreadyRegistered:
        return "Component error. Component already registered in the Context. ";
    ...
    case ErrorCode::System_NotRegistered:
        return "System error. System not registered in the Context. ";
    case ErrorCode::System_AlreadyRegistered:
        return "System error. System already registered in the Context. ";
