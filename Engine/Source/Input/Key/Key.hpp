...
{
    /**
     * @brief An enum class representing the keys on a keyboard.
     */
    enum class KeyEnum : Int
	{
		Unknown = -1,
		Space = 32,
		Apostrophe = 39,
	...
	MINTY_ENABLE_ENUM_OPERATORS(KeyEnum)
	...
	template<>
	struct Parser<KeyEnum>
	{
		static Bool parse(StringView const str, KeyEnum& value);
		static String to_string(KeyEnum const& obj);
	};
