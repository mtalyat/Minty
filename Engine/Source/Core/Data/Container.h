...
#pragma region Accessors
	...
	public:
		 ...
		 */
		virtual Pointer get_data() const = 0;
...
#pragma region Methods
	...
	public:
		 ...
		 */
		virtual void set_at(PointerConst const data, Size const size, Size const index) = 0;
		 ...
		 */
		virtual Bool set(PointerConst const data, Size const size);
		 ...
		 */
		virtual PointerConst get_at(Size const index) const = 0;
		 ...
		 */
		virtual Bool append(PointerConst const data, Size const size) = 0;
	...
	protected:
		inline virtual Bool append_one(PointerConst const object, Size const size) { return append(object, size); }
