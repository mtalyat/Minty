...
#pragma region Methods
         ...
         */
        void slice(Size const startIndex, Size const count = INVALID_SIZE) noexcept;
         ...
         */
        void trim_start(StringView const chars = DEFAULT_TEXT_WHITESPACE);

        /**
         * @brief Trims characters from the end of the StringBuilder.
         * @param chars The set of characters to trim. Default is whitespace characters.
         */
        void trim_end(StringView const chars = DEFAULT_TEXT_WHITESPACE);

        /**
         * @brief Trims characters from both the start and end of the StringBuilder.
         * @param chars The set of characters to trim. Default is whitespace characters.
         */
        void trim(StringView const chars = DEFAULT_TEXT_WHITESPACE);
         ...
         */
        void strip(StringView const chars = DEFAULT_TEXT_WHITESPACE);
