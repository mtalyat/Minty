...
#pragma region Methods
	...
	public:
		 ...
		 */
		String sub(Size const startIndex, Size const count = INVALID_SIZE) const noexcept;
		 ...
		 */
		inline StringView peek(Size const startIndex, Size const count = INVALID_SIZE) const noexcept
		{
		 ...
		 */
		inline Bool contains(Char const c) const noexcept { return find_first(c) != INVALID_SIZE; }
		 ...
		 */
		inline Bool contains(StringView const str) const noexcept { return find_first(str) != INVALID_SIZE; }
		 ...
		 */
		String trim_start(StringView const chars = DEFAULT_TEXT_WHITESPACE) const;
		 ...
		 */
		String trim_end(StringView const chars = DEFAULT_TEXT_WHITESPACE) const;
		 ...
		 */
		String trim(StringView const chars = DEFAULT_TEXT_WHITESPACE) const;
		 ...
		 */
		String strip(StringView const chars = DEFAULT_TEXT_WHITESPACE) const;
