...
namespace Minty
{
	...
	class Cargo
	{
		friend struct Serializer<Cargo>;
...
#pragma endregion
	...
	template<>
	struct Serializer<Cargo>
	{
		static Bool serialize(Writer& writer, Cargo const& value);
		static Bool deserialize(Reader& reader, Cargo& value);
	};
}
