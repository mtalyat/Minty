...
Minty::DynamicContainer::DynamicContainer(PointerConst const data, Size const size)
	: MemoryContainer()
{
...
Bool Minty::DynamicContainer::append(PointerConst const data, Size const size)
{
...
Bool Minty::DynamicContainer::reserve(Size const capacity)
{
	...
	Byte *const newData = m_allocator.allocate<Byte>(capacity);
