...
namespace Minty
{
    ...
    template<>
    struct Parser<WUInt2>
    {
        static Bool parse(StringView const str, WUInt2 &value);
        static String to_string(WUInt2 const &value);
    };

    template<>
    struct Parser<WUInt3>
    {
        static Bool parse(StringView const str, WUInt3 &value);
        static String to_string(WUInt3 const &value);
    };

    template<>
    struct Parser<WUInt4>
    {
        static Bool parse(StringView const str, WUInt4 &value);
        static String to_string(WUInt4 const &value);
    };
