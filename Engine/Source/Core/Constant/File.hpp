...
namespace Minty
{
	...
	constexpr Char const *EXTENSION_GEOMETRY = ".geo.minty";
	...
	constexpr Char const *EXTENSION_OBJ = ".obj";
	constexpr Char const *EXTENSION_PHYSICS_MATERIAL = ".phy.minty";
	constexpr Char const *EXTENSION_PIPELINE = ".pip.minty";
	...
	constexpr Char const *EXTENSION_SCRIPT = ".scr.minty";
	constexpr Char const *EXTENSION_SCRIPT_TUI = ".tui";
	constexpr Char const *EXTENSION_SCRIPT_SOURCE = ".cpp";
