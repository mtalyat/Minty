	...
	, m_commandPool(VK_NULL_HANDLE)
{
	...
	// create swapchain
	m_swapchain = Owner(new Vulkan_Swapchain(builder.targetSurfaceFormat, queueFamilyIndices));
...
void Minty::Vulkan_RenderManager::recreate_swapchain()
{
	...
	m_swapchain.release();
	m_swapchain = Owner(new Vulkan_Swapchain(targetFormat, queueFamilyIndices));
}
