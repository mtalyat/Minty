...
void test_Vector(Test& _test)
{
	...
	CATEGORY(Vector::ConstIterator)
	{
		TEST("Copy Constructor")
		{
			Vector<int> const test(3, 5);
			Vector<int>::ConstIterator it = test.begin();
		...
		{
			Vector<int> const test(3, 5);
			Vector<int>::ConstIterator it = test.end();
			EXPECT_TRUE(*(it - 1) == 5);
			EXPECT_TRUE(*(it - 2) == 5);
			EXPECT_TRUE(it - 3 == test.begin());
			EXPECT_TRUE(*--it == 5);
	...
	CATEGORY(Vector::ConstReverseIterator)
	{
		...
		{
			Vector<int> const test(3, 5);
			Vector<int>::ConstReverseIterator it = test.rbegin();
		...
		{
			Vector<int> const test(3, 5);
			Vector<int>::ConstReverseIterator it = test.rend();
			EXPECT_TRUE(*(it - 1) == 5);
			EXPECT_TRUE(*(it - 2) == 5);
			EXPECT_TRUE(it - 3 == test.rbegin());
			EXPECT_TRUE(*--it == 5);
